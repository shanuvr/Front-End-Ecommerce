      ...
      {user ? (
        <div className="max-w-6xl mx-auto p-4 grid md:grid-cols-3 gap-6">
                ...
                return (
                  <div key={ind} className="flex items-center border-b py-4">
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      <button
                        className=" bg-gray-500 text-white rounded-4xl px-2 py-2 hover:scale-95 m-4"
                        onClick={() => {
                          handleqty(ele.productId, ele.quantity + 1);
                        }}
                      >
                        +
                      </button>
          ...
          {cartitems.length > 0 ? (
            ...
            <button
              className=" px-2 py-2 bg-cyan-800 text-white rounded-4xl"
              onClick={() => {
                navigate("/orders");
              }}
            >
        ...
        <div className=" w-screen h-screen flex flex-col justify-center items-center gap-4">
          ...
          <div className=" transition-all duration-300 hover:scale-90 p-4 rounded-4xl shadow-[8px_3px_10px_5px_rgba(0,_0,_0,_0.1)]">
            <button
              className=" hover:scale-125 duration-500 text-white text-2xl transition-all px-9 py-3.5 bg-green-700 rounded-4xl "
              onClick={() => {
                navigate("/login");
              }}
            >
