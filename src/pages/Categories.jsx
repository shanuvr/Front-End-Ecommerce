  ...
  return (
    <AdminLayout>
      ...
      <button
        ...
        className=" bg-violet-500 text-white px-8 py-2 rounded-2xl m-2.5 hover:scale-x-105 transition-transform font-bold"
      >
        Add Category
      </button>
              ...
              <tr key={ind}>
                ...
                <td className="py-2 px-4 border-gray-100">
                  <button
                    ...
                    className="bg-purple-700 text-white rounded-2xl px-3 py-1"
                  >
                    Edit
                  </button>
                  <button
